...
import {
  ...
  weightUnits,
} from "./_constants/weightConversionRates";
...
export default function WeightConverter() {
  ...
  const filteredWeightUnits = weightUnits.filter((unit) =>
    availableToUnits.includes(unit.key)
  );

  const unitSymbols = weightUnits.reduce((acc, unit) => {
